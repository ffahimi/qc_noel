...
# plot(avgbulls,  title='Bull Pressure',  color=color.green,      linewidth=1)
# plot(avgbears,  title='Bear Pressure',  color=color.red,     linewidth=1)
# plot(TPX,       title='Net Pressure',   color=color.blue,   linewidth=2)
