...
class CustomIndicatorAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # self.SetWarmup(self.asgma_period) it's too short for the indicators
        ...
        seseseseseseseseseseseseseseseseseseseself.SetPortfolioConstruction(EqualWeightingPortfolioConstructionModel(lambda time: None, PortfolioBias.LongShort))
        ...
        for symbol, symbolData in self.symbol_data_by_symbol.items():
            ...
            if newDirection is not None:
                ...
                if isNotInvestedOrOpposite:
                    ...
                    insight = Insight.Price(symbol, timedelta(days=1), newDirection)
